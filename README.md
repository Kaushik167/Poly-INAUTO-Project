...
### **📘 3. PriceData Excel File**<img width="621" height="392" alt="price_data_preview" src="https://github.com/user-attachments/assets/943fd7fd-7096-4fb9-b38b-add7bfb443cd" />

This file contains the final comparison table and the automated column chart visualization. Click the image to download the full Excel workbook.
